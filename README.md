...
| `audio_latency` | `48` | PCSX-ReARMed pin: tighter than the global `64` (interpreter-only Tier 2 needs lower coreaudio buffer); all other cores inherit the global |
