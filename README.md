...
[![paired](https://img.shields.io/badge/paired-retroarch--appletv4k%20v4.0-orange.svg)](https://github.com/ryanmusante/retroarch-appletv4k)
...
|------|---------|------|--------|--------|-------|
| Beetle PCE Fast | PC Engine / TG-16 | 1 | 2 | 3 | CD precache + 2× streaming; no sprite limit; Run Ahead single-instance |
